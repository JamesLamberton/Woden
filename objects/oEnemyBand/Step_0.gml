...
if collision and tToggle{
	...
	option_a_impact_sucess = [0,-size/2,0,15,"",0];
	...
	option_b_impact_sucess = [-10,-size/4,0,20,"",0];
	...
	option_b_impact_sucess = [-10,-ceil(oHero.followers*0.9),-ceil(oHero.food*0.9),0,"",0];
	...
	option_c_impact_sucess = [0,-ceil(oHero.followers*0.7),0,-ceil(oHero.food*0.7),"",0];
}
